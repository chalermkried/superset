...
import { HandlebarsExtendedProps, HandlebarsExtendedStylesProps } from './types';

const Styles = styled.div<HandlebarsExtendedStylesProps>`
...
export default function HandlebarsExtended(props: HandlebarsExtendedProps) {
